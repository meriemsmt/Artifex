                            ...
                            <div class="col-12 col-sm-8 text-center text-sm-left">
                                <div class="toolbar-sorter-right">
                                    ...
                                    <form action="shop.php" method="post">
                                          ...
                                          <select id="basic" class="selectpicker show-tick form-control" data-placeholder="DZD" name="basic" onchange="this.form.submit()">
                          									<option data-display="Select">Nothing</option>
                          									<option value="1" href='shop.php?opt=HpLp'>High Price → Low Price</option>
                          									<option value="2" href='shop.php?opt=LpHp'>Low Price → High Price</option>
                          								</select>
                                ...
                                <?php
                                    if (isset($_POST['basic'])) {
                                        ...
                                        if ($basic=1) {
                                            $queryy = "SELECT * FROM products ORDER BY price_product DESC";
                                        }elseif ($basic=2) {
                                            $queryy = "SELECT * FROM products ORDER BY price_product ASC";
                                        }

                                        $queryy_run = mysqli_query($dbconn, $queryy);

                                        foreach($queryy_run as $row){
                                            echo "
                                            <li><a href='shop.php?opt='.$basic </a></li>
