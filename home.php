...
<head>
    ...
    <!-- Site Metas -->
    <title>Artifex - Share Your Art</title>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-widget">
                            <h4>About Artifex</h4>
                            <p>Artifex is a website specialized in creating exceptional art in different categories and a platform gathering  <strong>talented artists</strong> from all over the world, promoting them and their original and outstanding work.
                            </p>
                            <ul>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-link-contact">
                            ...
                            <ul>
                                ...
                                <li>
                                    <p><i class="fas fa-phone-square"></i>Phone: <a href="tel:+213-666602839">+213-666 602 839</a></p>
                                </li>
                                <li>
